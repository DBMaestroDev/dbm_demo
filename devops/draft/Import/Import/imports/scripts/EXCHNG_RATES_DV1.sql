...
GRANT SELECT ON __SCHEMA__.FREQ_FACTOR TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.GEO_SALE_TAX TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CONDITION TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CONDITION_BAK TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CONDTN_RLTNP TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CONDTN_RLTNP_BAK TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CRITERIA TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CRITERIA_BAK TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_FREQ_FACTOR TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_PRICING_BAK TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_SALE_TAX_RLTNP TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_THLD TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.REF_RATE TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SALE_TAX_RATE TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SQ_FREQ_FACTOR_ID TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SQ_GEO_SALE_TAX_ID TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SQ_PRDACT_ID TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SQ_PRDASC_ID TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SQ_PRDCHA_ID TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SQ_PRDT_CONDITION_ID TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SQ_REF_RATE_ID TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.TBPRDACT_PRDT_ACTIVITY TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.TBPRDASC_PRDT_ACTVT_SCHEDULE TO RL_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.TBPRDCHA_PRDT_CHARACTERISTIC TO RL_RATES_DV1_READONLY;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.FREQ_FACTOR TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.GEO_SALE_TAX TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CONDITION TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CONDITION_BAK TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CONDTN_RLTNP TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CONDTN_RLTNP_BAK TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CRITERIA TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CRITERIA_BAK TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_FREQ_FACTOR TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_PRICING_BAK TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_SALE_TAX_RLTNP TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_THLD TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.REF_RATE TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.SALE_TAX_RATE TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.SQ_FREQ_FACTOR_ID TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.SQ_GEO_SALE_TAX_ID TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.SQ_PRDACT_ID TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.SQ_PRDASC_ID TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.SQ_PRDCHA_ID TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.SQ_PRDT_CONDITION_ID TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.SQ_REF_RATE_ID TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.TBPRDACT_PRDT_ACTIVITY TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.TBPRDASC_PRDT_ACTVT_SCHEDULE TO RL_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.TBPRDCHA_PRDT_CHARACTERISTIC TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.FREQ_FACTOR TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.GEO_SALE_TAX TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CONDITION TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CONDTN_RLTNP TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_CRITERIA TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_FREQ_FACTOR TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_SALE_TAX_RLTNP TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.PRDT_THLD TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.REF_RATE TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.SALE_TAX_RATE TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.TBPRDACT_PRDT_ACTIVITY TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.TBPRDASC_PRDT_ACTVT_SCHEDULE TO RO_RATES_DV1_READONLY;

GRANT SELECT ON __SCHEMA__.TBPRDCHA_PRDT_CHARACTERISTIC TO RO_RATES_DV1_READONLY;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.FREQ_FACTOR TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.GEO_SALE_TAX TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CONDITION TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CONDTN_RLTNP TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_CRITERIA TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_FREQ_FACTOR TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_SALE_TAX_RLTNP TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_THLD TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.REF_RATE TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.SALE_TAX_RATE TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.TBPRDACT_PRDT_ACTIVITY TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.TBPRDASC_PRDT_ACTVT_SCHEDULE TO RO_RATES_DV1_READWRITE;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.TBPRDCHA_PRDT_CHARACTERISTIC TO RO_RATES_DV1_READWRITE;
...
/*
GRANT SELECT ON __SCHEMA__.PRDT_PRICING TO RL_RATES_DV1_READONLY;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_PRICING TO RL_RATES_DV1_READWRITE;

GRANT SELECT ON __SCHEMA__.PRDT_PRICING TO RO_RATES_DV1_READONLY;

GRANT DELETE, INSERT, SELECT, UPDATE ON __SCHEMA__.PRDT_PRICING TO RO_RATES_DV1_READWRITE;
